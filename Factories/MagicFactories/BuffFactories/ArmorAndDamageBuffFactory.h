...
private:
	...
	{
		GODS_ARMOR_AMPLIFY_ARMOR = 2, GODS_ARMOR_AMPLIFY_DAMAGE = 8, GOD_ARMOR_MANA_COST = 25, GODS_ARMOR_DURATION = 2,
		BLESS_AMPLIFY_ARMOR = 1, BLESS_AMPLIFY_DAMAGE = 6, BLESS_MANA_COST = 15, BLESS_DURATION = 2
	};
};
